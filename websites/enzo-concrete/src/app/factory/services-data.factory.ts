  ...
  return [
    {
      ...
      featuredImage: '/stamped-concrete.webp',
      shortDescription:
      ...
      content: `
        ...
        <p>Ready to transform your outdoor spaces? <strong>Contact us today</strong> for a free consultation!</p>
      `,
      houseApplications: [
        'Driveways',
        'Patios',
    ...
    },
    {
      ...
      featuredImage: '/brushed-concrete.webp',
      shortDescription:
      ...
      content: `
        <h2>Brushed Concrete</h2>
        <p>Brushed concrete is known for its classic, slip-resistant finish, achieved by brushing the surface before it fully sets. It's a versatile and cost-effective option, widely used in residential and commercial applications.</p>

        <h3>Benefits of Brushed Concrete</h3>
        <ul>
        ...
        <p>Brushed concrete combines functionality and durability. <strong>Get in touch today</strong> to explore options for your project!</p>
      `,
      houseApplications: [
        'Driveways',
        'Sidewalks',
    ...
    },
    {
      ...
      featuredImage: '/assets/images/exposed-aggregate.jpg',
      shortDescription:
      ...
      content: `
        ...
        <p>Exposed aggregate is a durable and decorative concrete finish that reveals the natural beauty of stones and pebbles. It's a popular choice for homeowners seeking a unique texture and enhanced slip resistance for outdoor spaces.</p>

        <h3>Benefits of Exposed Aggregate</h3>
        <ul>
        ...
        <ul>
          ...
          <li>Patios</li>
          <li>Walkways</li>
          <li>Outdoor Stairs</li>
          <li>Porches</li>
        </ul>

        <p>Looking to add style and durability to your property? <strong>Contact us today</strong> for a free consultation!</p>
      `,
      houseApplications: [
        'Driveways',
        'Pool Decks',
