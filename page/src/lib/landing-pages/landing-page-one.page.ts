...
@Component({
  selector: 'page-landing-page-one',
  imports: [],
  template: `
    <div class="bg-white">
      <!-- Header -->
      ...
      <main class="isolate">
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  class="mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold text-indigo-600 ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Buy plan
                </a>
              </div>
              ...
              >
                <div>
                  <div class="flex items-center justify-between gap-x-4">
                    <h3
                      id="tier-startup"
                      class="text-lg/8 font-semibold text-indigo-600"
                    >
                      Startup
                    </h3>
                    <p
        ...
        <div class="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div class="mx-auto max-w-2xl text-center">
            ...
            <p
              class="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600"
            >
...
export class LandingPageOnePage {}
